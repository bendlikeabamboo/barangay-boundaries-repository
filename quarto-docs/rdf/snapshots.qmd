---
title: PSGC snapshot history
description: |
  Quarterly Philippine Standard Geographic Code (PSGC) change history across 17 snapshots from
  2021-08-19 to 2026-04-13, each processed into an RDF delta.
...
reclassification, and code-change events relative to the previous snapshot — see
...
For dataset and documentation **versions** (release tags), see the
[Changelog](../changelog.qmd); for the version-tag convention see
[Releases & versioning](../boundaries/download.qmd).
